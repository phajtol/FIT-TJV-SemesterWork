...
/**
 * Jersey REST client generated for REST resource:AdresaFacadeREST [adresa]<br>
 * USAGE:
 * <pre>
 *        AdresaClient client = new AdresaClient();
...
public class AdresaClient {
    ...
    public AdresaClient() {
        ...
        webTarget = client.target(BASE_URI).path("adresa");
    }
    ...
    public List<Adresa> findAll() throws ClientErrorException {
        WebTarget resource = webTarget;
